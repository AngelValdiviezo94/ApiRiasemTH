...
namespace EnrolApp.Domain.Entities.Justificacion;
...
public class SolicitudJustificacion
{
    ...
    [Column("idMarcacion")]
    public Guid? IdMarcacion { get; set; }

    [Column("idMarcacionG")]
    public int? IdMarcacionG { get; set; }
    //public virtual MarcacionColaborador MarcacionColaborador { get; set; }
