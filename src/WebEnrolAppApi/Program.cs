using EnrolApp.Application;
using EnrolApp.Persistence;
using Microsoft.OpenApi.Models;
using WebEnrolAppApi.Extensions;
using FluentValidation.AspNetCore;
using ServiceExtAplication = EnrolApp.Application.ServiceExtensions;
...
try
{
    ...
    builder.Services.AddSwaggerGen(c =>
    {
        c.SwaggerDoc("v1", new OpenApiInfo
        {
            Version = "v1",
            Title = "EnrolApp - API",
            Description = "Web API que permite gestionar los servicios del Ecosistema de Compra de Productos y Servicios en Tiendas del Barrio del Grupo Corporativo RIASEM",
